*This project has been created as part of the 42 curriculum by angnavar, kpineda- and ikondrat*
...
## Project Description
**Webserv** is a custom HTTP server written in **C++98** capable of handling multiple clients using `epoll()`.
